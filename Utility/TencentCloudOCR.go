...
func main() {
	...
	credential := common.NewCredential(
		"AKIDWXUS0TX282QehaFxOglleOzWr4kBDmy2",
		"1ymQt9E792kGLBytGOODtAFGrMgy7OWS",
	)
	...
	dataByte, _ := ioutil.ReadFile(imgFIle)
	dataBase64 := base64.StdEncoding.EncodeToString(dataByte)
	request.ImageBase64 = &dataBase64
	...
	// 打印返回的json字符串
	fmt.Printf("%s", *response.Response.TextDetections[0].DetectedText)
}
